...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    개발자로서 기본기를 쌓기 위해서 공학적 지식들을 정리하고자 개인 블로그를 운영 중에 있으며 꾸준히 복습하는 것에 도움이 많이 되고 있습니다.`,
    ...
    `,
    '이 외에도 좋은 코드를 쓰기 위해서 최근에는 오픈소스 분석에 관심을 갖고 있으며, 페이지 네이션 기능을 NPM 라이브러리로 배포하여 실제 프로젝트에 적용한 경험이 있습니다.',
  ],
  sign: '',
