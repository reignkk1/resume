...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    `새로운 기술을 습득하는 데 즐거움을 느끼고 있고 문제해결 능력과 창의적 사고를 통해 프로젝트를 성공적으로 이끌어내는 것이 목표입니다. 이 외에도 좋은 코드를 쓰기 위해서 최근에는 오픈소스 분석에 관심을 갖고 있으며, 페이지 네이션 기능을 NPM 라이브러리로 배포하여 실제 프로젝트에 적용한 경험이 있습니다.
    `,
